...
sealed interface NewsItemWrapper {
    ...
    data class EgtesadOnline(override val item: ir.hasanazimi.avand.data.entities.remote.news.egtesad_online.Item, override val source: NewsSources) : NewsItemWrapper
