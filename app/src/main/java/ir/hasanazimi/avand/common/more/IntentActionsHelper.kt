package ir.hasanazimi.avand.common.more
...
import ir.hasanazimi.avand.common.extensions.isAppAvailable
...
class IntentActionsHelper(private val activity: Activity) {
    ...
    fun sendEmail(email: String) {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, ir.hasanazimi.avand.R.string.app_name)
